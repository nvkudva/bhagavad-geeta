...
- [x] Then repeat the whole list for Telugu, which has its own scan output and its own 53-verse untranslated-word list. Telugu scans 613/700 clean on its own, the residue being the X-or-X glosses below. Merging it surfaced five verses whose `commentary_english` is a placeholder rather than commentary — 6.38, 8.1, 8.5, 12.3, 12.18 — which were being translated into sentences that read as commentary while saying only that none exists. They are now skipped in both languages and fall back to the English.
